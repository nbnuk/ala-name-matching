...
public enum RankType {
    ...
    INFRAKINGDOM(1300, "infrakingdom", Rank.INFRAKINGDOM, null, 1300, false, "http://rs.tdwg.org/ontology/voc/TaxonRank#Infrakingdom"),
    ...
    DIVISION(2010, "division", null, null, 2010, false),
    ...
    SUBDIVISION(2210, "subdivision", null, null, 2210, false),
    INFRAPHYLUM(2300, "infraphylum", Rank.INFRAPHYLUM, null, 2300, false,  "http://rs.tdwg.org/ontology/voc/TaxonRank#Infraphylum", "infradivision botany"),
    ...
    SUBTERCLASS(3205, "subterclass", null, null, 3205, false),
    ...
    SECTION(4471, "section", Rank.SECTION, null, 4471, false),
    SUBSECTION_ZOOLOGY(4475, "subsection zoology", null, null, 4475, false),
    SUBSECTION(4476, "subsection", Rank.SUBSECTION, null, 4476, false),
    ...
    GENUS_AGGREGATE(5951, "genus aggregate", null, null, 5951, true),
    GENUS(6000, "genus", Rank.GENUS, 3f, 6000, false, "http://rs.tdwg.org/ontology/voc/TaxonRank#Genus", "Genus"),
    GENERIC_HYBRID(6001, "generic hybrid", null, null, 6001, false),
    ...
    SPECIES_HYBRID(7002, "species hybrid", null, null, 7002, false),
    SPECIES_PRO_PARTE(7010, "species pro parte", null, null, 7010, false),
    SPECIES_SENSU_LATO(7020, "species sensu lato", null, null, 7020, false),
    ...
    PRAESPECIES(8006, "praespecies", null, null, 8006, false),
    SUBLUSUS(8007, "sublusus", null, null, 8007, false),
    SUBSPECIES_AGGREGATE(8008, "subspecies aggregate", null, null, 8008, false),
    SUBSPECIES_HYBRID(8009, "subspecies hybrid", null, null, 8009, false),
    ...
    CONVARIETY(8012, "convariety", null, null, 8012, false),
    VARIETAL_HYBRID(8013, "varietal hybrid", null, null, 8013, false),
    ...
    ECAD(8051, "ecad", null, null, 8051, false),
    PATHOVAR(8080, "pathovar", Rank.PATHOVAR, null, 8080, false),
    ABERRATION(8100, "aberration", Rank.ABERRATION, null, 8100, false, "abberation"),
    RACE(8120, "race", Rank.RACE, null, 8120, false),
    FORMA_SPECIALIS(8140, "forma specialis", Rank.FORMA_SPECIALIS, null, 8140, false),
    //HYBRID(8150, "hybrid", null, null, 8150, true),
    BREED(8150, "breed", null, null, 8150, true),
    ...
    MICROGENE(8200, "microgene", null, null, 8200, true),
    MICROSPECIES(8250, "microspecies", null, null, 8250, true),
    MORPHOTYPE(8300, "morphotype", null, null, 8300, true),
    FACIES(8305, "facies", null, null, 8305, true),
